...
common/jdk-14.0.2/bin/java -Xmx12g -cp sr4rc.jar it.units.erallab.SR4RC randomSeed=$SLURM_ARRAY_TASK_ID evolver=$EVOLVER gridSize=10 nGaussian=10 dir=$DIRNAME statsFile=stats-$SLURM_ARRAY_TASK_ID.txt
